...
struct graph *testgraph_alloc_dodec() {
     ...
     graph_add_edge(g, n5 , n1 );
     graph_add_edge(g, n1 , n6 );
     graph_add_edge(g, n2 , n8 );
     graph_add_edge(g, n3 , n10);
     graph_add_edge(g, n4 , n2 );
     graph_add_edge(g, n5 , n14);
     graph_add_edge(g, n6 , n7 );
     graph_add_edge(g, n7 , n8 );
     graph_add_edge(g, n8 , n9 );
     graph_add_edge(g, n9 , n10);
     graph_add_edge(g, n10, n11);
     graph_add_edge(g, n11, n12);
     graph_add_edge(g, n12, n13);
     graph_add_edge(g, n13, n14);
     graph_add_edge(g, n14, n15);
     graph_add_edge(g, n15, n6 );
     graph_add_edge(g, n7 , n17);
     graph_add_edge(g, n9 , n18);
     graph_add_edge(g, n11, n19);
     graph_add_edge(g, n13, n20);
     graph_add_edge(g, n15, n16);
     graph_add_edge(g, n16, n17);
     graph_add_edge(g, n17, n18);
     graph_add_edge(g, n18, n19);
     graph_add_edge(g, n19, n20);
     graph_add_edge(g, n20, n16);
